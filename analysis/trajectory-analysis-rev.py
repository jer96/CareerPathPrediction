...
for floor in range(300, len(users)-10, 10):
    ...
    # Alternate Binning
    company_bins = [0, 50, 200, 500, len(top_companies), len(top_companies)+1, len(top_companies)+3]
    company_bin_labels = ['T1', 'T2', 'T3', 'T4', 'T5', 'NONE']
    school_bins = [0, 50, 200, 500, len(top_schools), len(top_schools)+1, len(top_schools)+3]
    school_bin_labels = ['T1', 'T2', 'T3', 'T4', 'T5', 'NONE']
