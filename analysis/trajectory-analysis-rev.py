...
for floor in range(550, 551):
    ...
    # Alternate Binning
    company_bins = [-1, 50, 200, 500, len(top_companies), len(top_companies)+1, len(top_companies)+3]
    company_bin_labels = ['T1', 'T2', 'T3', 'T4', 'T5', 'NONE']
    school_bins = [-1, 50, 200, 500, len(top_schools), len(top_schools)+1, len(top_schools)+3]
    school_bin_labels = ['T1', 'T2', 'T3', 'T4', 'T5', 'NONE']
